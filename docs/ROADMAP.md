...
| MT3 | 壳与效率（文件树/大纲/多标签/查找替换/视图三件套/上下文菜单） | ✅ 2026-09-11（MT3a 壳核心 + MT3b 文件树/菜单，两提交单元） |
| MT4 | 主题调色板 + i18n + 会话 + 外部修改检测 | ✅ 2026-09-11 |
| MT4.5 | mermaid flowchart 字符画（D18 路线 B，其余类型仍占位框） | ✅ 2026-09-11（280 用例；备忘见 TUI.md §12f） |
